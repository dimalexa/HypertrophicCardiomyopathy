        ...
        <div>
            ...
            <div className='generalStyle'>
                ...
                <div className='blockWithImage' style={{'background-color' : '#f0f0f3', 'border-radius' : '25px'}}>
                    <div className="textGrey">
                        <h3><b>Гипертрофическая кардиомиопатия (ГКМП) — наиболее распространенное наследственное заболевание сердца. 
                            Вы не одиноки и сейчас есть много возможностей лечения. 
                        ...
                        <p></p>
                        <h3><b>Также Вы можете прочитать истории людей, живущих с этим диагнозом, собранные на этой странице: </b></h3>
                        <button className="navButton">
                ...
                <div className="textHeaderGrey">
                   Что такое гипетрофическая кардиомиопатия?
                </div>
                ...
                <div className="textGrey" style={{'padding' : '20px 0px', 'border-bottom' : '3px solid #5a5f91', 'border-top' : '3px solid #5a5f91'}}> 
                    <ul>
                        <li><b>Это генетическое заболевание сердца, которое проявляется утолщением стенки сердца. 
                            </b> Оно не связано с артериальной гипертензией или пороками клапанов, с образом жизни - заболевание может проявиться 
                            вне зависимости от внешних факторов.</li>
                        <li><b>Это заболевание распространённое.</b> ГКМП встречается у <b> 1 из 500 человек (есть оценка и про 1 из 200 человек).</b> 
                        ...
                        <li><b>Крайне важно, что течение болезни индивидуально. </b>  У значительной части пациентов 
                ...
                <div className="textGrey">
                    <ol>
                        <li><b>Найдите врача, которому Вы сможете доверять.</b> Это важно, так как ГКМП - хроническое заболевание, и лучше, чтобы 
                        на протяжении всей болезни, за Вами наблюдал один и тот же врачИщите кардиолога, который специализируется на ГКМП 
                        или наследственных заболеваниях сердца.</li>
                        <li><b>Задавайте вопросы.</b> Составьте список всего, что вас волнует, перед приемом. «Что означает моя конкретная ситуация?»,
                             «Какая физическая активность мне полезна?», «Как часто нужно приходить на осмотр?». Обычно у врачей время ограничено, и 
                             это поможет не растеряться и не упустить возможность задать те вопросы, которые Вам важны. Получить информацию о Вашем здоровье 
                             в доступной форме - это Ваше законное право.</li>
