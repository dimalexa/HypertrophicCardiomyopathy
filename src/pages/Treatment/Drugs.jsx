            ...
            <div className="blockWhite">
                ...
                <div className='textGrey'>
                    ...
                    <p>
                        ...
                        <strong> не рекомендуется (их приём нужно обсудить с кардиологом)</strong>:
                    </p>
                    <ol>
                        <li>
                            Нитраты (нитроглицерин, изосорбида мононитрат и динитрат). Торговые названия - нитроспрей, нитрокор и похожие.
                        </li>
                        <li>
                            Ингибиторы фосфодиэстразы (силденафил, торговое название - виа-гра).
                        </li>
                        <li>
                            Дигоксин (одноименный препарат).
                        </li>
                        <li>
                            Дигидропиридиновые блокаторы кальциевых каналов (нифедипин, торговые названия - Кальцигард, Кордафлекс, Кордипин, Коринфарм).
                        </li>
                        <li>
                            Ингибиторы АПФ и антагонисты альдостерона. Эти препараты назначаются при повышенном давлении, их действующие вещества 
                            (можно найти в инструкции либо на коробке под обычным (торговым) названием) заканчиваются на -прил и -сартан.
                        </li>
                    </ol>
                    <p>
