...
export default function Test(){
  // Генерация 20 тестовых вопросов (для реального использования замените на свои)
  const questions = Array.from({ length: 20 }, (_, i) => ({
    id: i,
    question: `Вопрос №${i + 1}: Какая столица Франции?`,
    options: ['Берлин', 'Мадрид', 'Париж', 'Рим'],
    correct: 2, // для примера везде правильный ответ "Париж"
  }));
